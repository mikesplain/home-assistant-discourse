...
ADD base/install-nginx /tmp/install-nginx
...
ADD base/install-redis /tmp/install-redis
RUN /tmp/install-redis

ADD base/install-imagemagick /tmp/install-imagemagick
...
# process
ADD base/thpoff.c /src/thpoff.c
...
ADD base/runit-1 /etc/runit/1
ADD base/runit-1.d-cleanup-pids /etc/runit/1.d/cleanup-pids
ADD base/runit-1.d-anacron /etc/runit/1.d/anacron
ADD base/runit-1.d-00-fix-var-logs /etc/runit/1.d/00-fix-var-logs
ADD base/runit-2 /etc/runit/2
ADD base/runit-3 /etc/runit/3
ADD base/boot /sbin/boot

ADD base/cron /etc/service/cron/run
ADD base/rsyslog /etc/service/rsyslog/run
ADD base/cron.d_anacron /etc/cron.d/anacron
